...
export const CSV_SOURCE_GUIDE: CsvSourceGuideEntry[] = [
  ...
  },
  {
    ...
    confirmed: false,
    notes: "ROUGH - exact click-path for this export has not been screenshotted yet.",
  },
  {
    ...
    confirmed: false,
    notes: "ROUGH - SpyFu confirmed as the source tool, but the exact click-path for this export has not been screenshotted yet.",
  },
  {
